...
static int rd8x8_c(/*MpegEncContext*/ void *c, uint8_t *src1, uint8_t *src2, int stride, int h){
    ...
    uint64_t * aligned_bak = av_malloc(sizeof(uint64_t)*stride);
...
#define SET_CMP_FUNC(name) \
    ...
    c->h263_h_loop_filter= NULL;//h263_h_loop_filter_c;  fei.shu 20060705
    c->h263_v_loop_filter= NULL;//h263_v_loop_filter_c;   fei.shu 20060705
