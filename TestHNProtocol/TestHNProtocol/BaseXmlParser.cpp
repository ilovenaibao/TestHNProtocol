...
XML_Char* BaseXmlParser::CreateXmlBuffer(XmlElement *all_elements)
{
...
int BaseXmlParser::AddFrameInfoToXml(scew_tree *xml_tree, XmlElement *pelement)
{
	int ret = 0;
...
XML_Char* BaseXmlParser::SaveXmlIntoBuffer(scew_tree *m_xml_tree, int buf_size)
{
...
void BaseXmlParser::PrintXmlBuffer(XML_Char *xml_buffer)
{
	// print xml buffer
	if (NULL == xml_buffer) {
...
int BaseXmlParser::AddXmlElement_(scew_element *element, XmlElement *add_element, int add_kind)
{
	int ret = 0;
...
int BaseXmlParser::AddXmlElement_2(scew_element *element, XmlElement *add_element, int add_kind)
{
	int ret = 0;
	scew_attribute *attribute = NULL;
...
XML_Char* BaseXmlParser::AddElementInXmlBuffer(XML_Char *buffer_in, XmlElement *add_element, int add_kind)
{
	...
	p_xml_buffer = save_xml_into_buffer(tree, strlen(buffer_in) + 100);
	if (NULL != buffer_in) {
		free(buffer_in);
		buffer_in = NULL;
	}
...
void BaseXmlParser::GetElementInXmlBuffer(XML_Char *buffer_in, XmlElement *in_element)
{
	scew_reader *reader = NULL;
	scew_parser *parser = NULL;
	scew_tree *tree = NULL;
...
int BaseXmlParser::GetXmlElement_(scew_element *element, XmlElement *in_element)
{
	int ret = 0;
	XML_Char const *element_key = NULL;
	XML_Char const *contents = NULL;
...
void BaseXmlParser::GetXmlElement_2(scew_element *element, XmlElement *out_element)
{
	XML_Char const *contents = NULL;
	if (NULL == element)
	{
